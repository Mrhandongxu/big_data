...
public class Imdb {
    ...
    public static void main(String[] args) {
        try {
            ...
            Thread threadLoadActProd = new Thread(() -> loadActAndProduce());
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!values[1].equals("\\N")) {
                    ...
                    for (String director : values[1].split(",")) {
                        ...
                        directStat.append(director.substring(2)).append(");");
                        try {
    ...
    /**
     * Main function to load information from file and insert some into table
     * movie.
     */
